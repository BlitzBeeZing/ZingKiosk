...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.OuterViewHolder> {
    ...
    @NonNull
    @Override
    public CartAdapter.OuterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_items_list, parent, false);
        return new CartAdapter.OuterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CartAdapter.OuterViewHolder holder, int position) {
